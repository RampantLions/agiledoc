...
public class SequenciaGanhadora {
	...
	public static void showWinner(int currentMoveRow, int currentMoveColumn) {
		...
		if (VariaveisGlobais.statusCorrenteDoJogo.getSequenciaGanhadora().equals(
				EntidadeJogo.SEQUENCE_ROW)) {
		...
		} else if (VariaveisGlobais.statusCorrenteDoJogo.getSequenciaGanhadora()
				.equals(EntidadeJogo.SEQUENCE_COLUMN)) {
			...
			Tabuleiro.gameGrid.setHTML(2, currentMoveColumn, marker);
				...
				.equals(EntidadeJogo.SEQUENCE_DIAGONAL_RIGHT)) {
			...
			Tabuleiro.gameGrid.setHTML(2, 0, marker);
				...
				.equals(EntidadeJogo.SEQUENCE_DIAGONAL_LEFT)) {
		...
		Tabuleiro.gameGrid.addClickHandler(HelpHint
				.getClickHandler(
