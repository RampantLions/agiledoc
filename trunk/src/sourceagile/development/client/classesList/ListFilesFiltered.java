...
public class ListFilesFiltered extends VerticalPanel {

	public ListFilesFiltered(HashMap<String, ClassFile> entries, String tagType) {
		...
		for (ClassFile entry : classFiles) {
			...
			if (entry.getClassDoc() != null
					&& tagType.equals(entry.getClassDoc().getTagType())) {
