...
public class LocaleList extends ListBox {
	...
	public LocaleList(String projectLocale) {
		...
		this.addItem(internationalizationConstants.english(),
				Project.LOCALE_ENGLISH);
		this.addItem(internationalizationConstants.portugues(),
				Project.LOCALE_PORTUGUESE);
		this.addItem(internationalizationConstants.espanol(),
				Project.LOCALE_SPANISH);
